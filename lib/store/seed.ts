...
export function createSeedData(): AppState {
  const products = [
    ...
    },
    {
      ...
      name: "Fast Shift (Plane) Migration",
    ...
    {
      id: "prod-o58uo345",
      name: "DevOps Tool Hosting on Forge",
      description: "Any of the DevOPs tools (JFROG, GITLAB, CB, CODER) on Forge ",
      generally_available: "January",
      gross_annual_price: 10000,
      platform_support_services_pct: 0,
      ...
      selected_variant: "medium" as const,
      variants: makeVariants(
        { gross_annual_price: 50000, platform_support_services_pct: 0, professional_services_pct: 25, software_resale_pct: 25, cloud_consumption_pct: 25, pss_pct: 25, user_count: "" },
        { gross_annual_price: 75000, platform_support_services_pct: 0, professional_services_pct: 25, software_resale_pct: 25, cloud_consumption_pct: 25, pss_pct: 25, user_count: "" },
        { gross_annual_price: 100000, platform_support_services_pct: 0, professional_services_pct: 25, software_resale_pct: 25, cloud_consumption_pct: 25, pss_pct: 25, user_count: "" },
      ),
      status: "live" as const,
    },
    {
      id: "prod-au7eawfw",
      name: "DevOps PS engagement (25 hours -S, 50 hours - M, 100 hours- L )",
      description: "",
      generally_available: "January",
      gross_annual_price: 6500,
      platform_support_services_pct: 0,
      professional_services_pct: 25,
      software_resale_pct: 25,
      cloud_consumption_pct: 25,
      ...
      selected_variant: "medium" as const,
      variants: makeVariants(
        { gross_annual_price: 6500, platform_support_services_pct: 0, professional_services_pct: 100, software_resale_pct: 0, cloud_consumption_pct: 0, pss_pct: 0, user_count: "" },
        { gross_annual_price: 10000, platform_support_services_pct: 0, professional_services_pct: 100, software_resale_pct: 0, cloud_consumption_pct: 0, pss_pct: 0, user_count: "" },
        { gross_annual_price: 15000, platform_support_services_pct: 0, professional_services_pct: 100, software_resale_pct: 0, cloud_consumption_pct: 0, pss_pct: 0, user_count: "" },
      ),
      status: "live" as const,
    },
    {
      ...
      user_count: "",
      has_variants: true,
      selected_variant: "large" as const,
      variants: makeVariants(
        { gross_annual_price: 125000, platform_support_services_pct: 0, professional_services_pct: 50, software_resale_pct: 0, cloud_consumption_pct: 0, pss_pct: 50, user_count: "" },
        { gross_annual_price: 175000, platform_support_services_pct: 0, professional_services_pct: 50, software_resale_pct: 0, cloud_consumption_pct: 0, pss_pct: 50, user_count: "" },
        { gross_annual_price: 250000, platform_support_services_pct: 0, professional_services_pct: 25, software_resale_pct: 25, cloud_consumption_pct: 25, pss_pct: 25, user_count: "" },
      ),
      status: "live" as const,
    },
    {
      id: "prod-ncbjy80t",
      name: "Archera (margins)",
      description: "Margins associated to Cloud Spend",
      generally_available: "January",
      gross_annual_price: 1200,
      platform_support_services_pct: 0,
      professional_services_pct: 25,
      software_resale_pct: 25,
      cloud_consumption_pct: 25,
      ...
      selected_variant: "small" as const,
      variants: makeVariants(
        { gross_annual_price: 12000, platform_support_services_pct: 0, professional_services_pct: 0, software_resale_pct: 100, cloud_consumption_pct: 0, pss_pct: 0, user_count: "" },
        { gross_annual_price: 15000, platform_support_services_pct: 0, professional_services_pct: 0, software_resale_pct: 100, cloud_consumption_pct: 0, pss_pct: 0, user_count: "" },
        { gross_annual_price: 20000, platform_support_services_pct: 0, professional_services_pct: 0, software_resale_pct: 100, cloud_consumption_pct: 0, pss_pct: 0, user_count: "" },
      ),
      status: "live" as const,
    },
  ];
