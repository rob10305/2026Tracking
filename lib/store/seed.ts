  ...
  const products = [
    {
      ...
      variants: makeVariants(
        { gross_annual_price: 40900, platform_support_services_pct: 37, professional_services_pct: 43, software_resale_pct: 0, cloud_consumption_pct: 21, pss_pct: 0, user_count: "N/A" },
        { gross_annual_price: 15000, platform_support_services_pct: 0, professional_services_pct: 20, software_resale_pct: 15, cloud_consumption_pct: 50, pss_pct: 0, user_count: "N/A" },
        { gross_annual_price: 15000, platform_support_services_pct: 0, professional_services_pct: 20, software_resale_pct: 15, cloud_consumption_pct: 50, pss_pct: 0, user_count: "N/A" },
      ),
    ...
    },
    {
      ...
      has_variants: true,
      selected_variant: "small" as const,
      variants: sameVariant({ gross_annual_price: 12000, platform_support_services_pct: 0, professional_services_pct: 15, software_resale_pct: 25, cloud_consumption_pct: 40, pss_pct: 20, user_count: "" }),
      status: "live" as const,
    },
    {
      id: "prod-mcp-hub",
      ...
      has_variants: true,
      selected_variant: "small" as const,
      variants: sameVariant({ gross_annual_price: 18000, platform_support_services_pct: 0, professional_services_pct: 20, software_resale_pct: 20, cloud_consumption_pct: 40, pss_pct: 20, user_count: "" }),
      status: "live" as const,
    },
    {
      id: "prod-ai-insights",
      ...
      has_variants: true,
      selected_variant: "small" as const,
      variants: sameVariant({ gross_annual_price: 20000, platform_support_services_pct: 0, professional_services_pct: 15, software_resale_pct: 20, cloud_consumption_pct: 45, pss_pct: 20, user_count: "" }),
      status: "live" as const,
    },
    {
      ...
      has_variants: true,
      selected_variant: "small" as const,
      variants: sameVariant({ gross_annual_price: 25000, platform_support_services_pct: 0, professional_services_pct: 20, software_resale_pct: 15, cloud_consumption_pct: 50, pss_pct: 15, user_count: "" }),
      status: "live" as const,
    },
    {
